...
#import "CTSI_TabBarController.h"

@interface CTSI_TabBarController ()
@property (nonatomic, assign) CTSI_TabBarControllerType tabbarType;
@property (nonatomic, assign) CGFloat titleFont;
@end

@implementation CTSI_TabBarController
...
- (void)setTabBarControllerType:(CTSI_TabBarControllerType)tabBarControllerType{
    _tabBarControllerType = tabBarControllerType;
    switch (self.tabBarControllerType) {
        case CTSI_TabBarControllerStatic:
            
            break;
        case CTSI_TabBarControllerDynamic:
        {
        ...
        case CTSI_TabBarControllerCamera:
        {
