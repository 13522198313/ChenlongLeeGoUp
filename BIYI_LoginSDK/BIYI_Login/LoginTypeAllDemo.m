...
@interface LoginTypeAllDemo ()<BIYI_LoginViewDelegate>
...
- (BIYI_LoginView *)loginView{
    if (!_loginView) {
       ...
       _loginView = [BIYI_LoginView BIYI_LoginViewWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height) withLoginType:LoginTypeAll IsShowLoginAdmPinView:NO];
