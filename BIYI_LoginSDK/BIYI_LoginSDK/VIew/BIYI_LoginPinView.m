...
#define GAPH 20
@interface BIYI_LoginPinView()<UITextFieldDelegate>
...
@implementation BIYI_LoginPinView
...
- (void)clickGetPinBtn{
    [_delegate BIYI_LoginPinViewDelegateGetPin];
...
- (void)textFieldDidEndEditing:(UITextField *)textField{
    ...
    if (textField == self.telTextField) {
           [_delegate BIYI_LoginPinViewDelegateWithTel:toBeString withPin:self.pinTextField.text];
       }else{
           [_delegate BIYI_LoginPinViewDelegateWithTel:self.telTextField.text withPin:toBeString];
       }
...
- (UIImageView *)telImageView{
    if (!_telImageView) {
        ...
        _telImageView.image = [UIImage imageNamed:MYFRAMEWORK_BUNDLE_IMG(@"BIYI_LoginView_username")];
    }
...
- (UIImageView *)pinImageView{
    if (!_pinImageView) {
        ...
        _pinImageView.image = [UIImage imageNamed:MYFRAMEWORK_BUNDLE_IMG(@"BIYI_LoginView_password")];
    }
